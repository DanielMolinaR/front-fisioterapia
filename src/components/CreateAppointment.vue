        ...
        <v-row>
          ...
          <v-col cols="12" sm="12">
            ...
            <small class="grey--text"
              >**Todos los campos deben de ser rellenados**</small
            >
            <br />
            <small class="grey--text"
              >Nota: Si el paciente no tiene una cuenta de usuario en el sistema
              seleccione la opción de "Usuario Nuevo"</small
            >
          </v-col>
        </v-row>
      </v-container>
    ...
    async submit() {
      try {
        ...
        let appointmentData = {
          ...
          Patient_surname: this.form.surname,
